...
namespace ODLGameEngine
{
    ...
    public abstract class BoardElement
    {
        ...
        public void EntityListOperation(PlacedEntity entity, EntityListOperation op)
        {
            ...
            if(allowedEntities.Remove(entity.PreInstanceInfo.EntityType)) // This one is always 1 so I don't need to iterate on it
            {
                ...
                {
                    EntityType nextEntityCombination = entity.PreInstanceInfo.EntityType; // This flag is always 1
