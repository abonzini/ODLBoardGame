    ...
    public partial class EffectBox : UserControl
    {
        ...
        void ShowRelevant(EffectType effect)
        {
            Control[] relevant = effect switch
            {
                ...
                EffectType.FIND_ENTITIES => [SearchCriterionBox, SearchCriterionLabel, TargetPlayerEnumBox, TargetPlayerLabel, TargetTypeEnumBox, TargetTypeLabel, InputBox, InputLabel, MultiVariableBox, MultiVariableLabel],
                EffectType.ADD_LOCATION_REFERENCE => [EffectLocationLabel, EffectLocationBox],
